...
void speichern(void)
{
	...
	// FILE-Zeiger save auf das Ende der Datei setzten
...
void ausgabe(void)
{
	...
	if(NULL == output){
		fprintf(stderr, "Kann \"adressen.dat\" nicht oeffnen!\n");
		return;
	}
...
int main(void)
{
	...
	do{
		...
		printf("-1- Neuen Datensatz hinzuguegen \n");
		printf("-2- Alle Datens#tze ausgeben\n");
